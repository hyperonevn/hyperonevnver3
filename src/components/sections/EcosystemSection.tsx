...
export const EcosystemSection: React.FC = () => {
  ...
  const ecosystemNodes = [
    ...
    { id: 3, name: 'HYPER LABS', description: t('ecosystem.hyperLabs'), orbit: 'orbit-l3', radius: 120 },
    ...
    { id: 6, name: 'HYPER PARTNERS', description: t('ecosystem.hyperPartners'), orbit: 'orbit-l6', radius: 180 },
